...
@Mod.EventBusSubscriber(modid = DenimMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        ModBlockTagGenerator modBlockTagGenerator = new ModBlockTagGenerator(packOutput, lookupProvider, DenimMod.MODID, existingFileHelper);
