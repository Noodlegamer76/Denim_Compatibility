package com.noodlegamer76.denim.client.models;// Made with Blockbench 4.11.1
...
public class BlockModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DenimMod.MODID, "block"), "main");
